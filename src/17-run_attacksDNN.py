...
def mnist_tutorial_cw(train_start=0, train_end=60000, test_start=0,
    ...
    saver.restore(sess, "/home/ahmed/Documents/Projects/IoT_Attack_Journal/Models/detection/DNN/TrainedModelDNN.ckpt")
...
###############################################
    ...
    # advLabels1= keras.utils.to_categorical(advLabels1, 2)
    # advLabels2 = model_argmax(sess, x, preds, adv2)
    # advLabels2= keras.utils.to_categorical(advLabels2, 2)
